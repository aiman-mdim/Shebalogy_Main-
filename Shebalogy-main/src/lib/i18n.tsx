...
const dict = {
  en: {
    nav_home: "Home",
    nav_cancer: "Cancer Detection",
    nav_blood: "Blood Donation",
    nav_mental: "Mental Health",
    nav_medicine: "Medicine Reminder",
    nav_doctors: "Doctors",
    login: "Login",
    signup: "Sign Up",
    logout: "Logout",
    ...
    hero_sub:
      "AI-augmented care across cancer detection, blood donation, mental wellness, and medicine reminders — built for all 9 divisions.",
    ...
    cancer_desc:
      "Take a guided survey to identify possible cancer type and stage, then get doctor suggestions in your division.",
    ...
    why_1_t: "Ethical AI",
    why_1_d: "Clinical validation logic with human-in-loop safeguards.",
    why_2_t: "Made for Bangladesh",
    why_2_d: "Localized for all 9 divisions, English and বাংলা.",
    why_3_t: "Offline resilience",
    why_3_d: "Low-bandwidth ready for rural reach.",
    why_4_t: "Privacy first",
    why_4_d: "Your data stays yours — WHO-aligned safeguards.",
    ...
    result: "Assessment",
    likely_type: "Likely focus area",
    estimated_stage: "Estimated risk level",
    ...
    night: "Night",
    remove: "Remove",
    notif_msg: "Take your medicine, you will recover soon.",
    // AI
  ...
  bn: {
    nav_home: "হোম",
    nav_cancer: "ক্যান্সার শনাক্তকরণ",
    nav_blood: "রক্তদান",
    nav_mental: "মানসিক স্বাস্থ্য",
    nav_medicine: "ওষুধের রিমাইন্ডার",
    nav_doctors: "ডাক্তার",
    login: "লগইন",
    signup: "সাইন আপ",
    logout: "লগআউট",
    ...
    hero_sub:
      "ক্যান্সার শনাক্তকরণ, রক্তদান, মানসিক সুস্থতা এবং ওষুধ রিমাইন্ডার — ৯টি বিভাগের জন্য AI-চালিত যত্ন।",
    ...
    cancer_desc:
      "একটি নির্দেশিত সার্ভে দিয়ে সম্ভাব্য ক্যান্সারের ধরন ও স্টেজ এবং বিভাগে চিকিৎসকের পরামর্শ পান।",
    blood_title: "রক্তদান",
    ...
    why_1_t: "নৈতিক AI",
    why_1_d: "ক্লিনিক্যাল ভ্যালিডেশন ও মানবিক সুরক্ষা।",
    why_2_t: "বাংলাদেশের জন্য",
    why_2_d: "৯টি বিভাগের জন্য, ইংরেজি ও বাংলা।",
    why_3_t: "অফলাইন প্রস্তুত",
    why_3_d: "গ্রামীণ অঞ্চলের জন্য কম-ব্যান্ডউইথে চলে।",
    why_4_t: "গোপনীয়তা অগ্রাধিকার",
    why_4_d: "আপনার ডেটা আপনারই — WHO-অনুমোদিত।",
    ...
    next: "পরবর্তী",
    back: "পূর্ববর্তী",
    submit: "মূল্যায়ন দেখুন",
    restart: "আবার শুরু",
    your_division: "আপনার বিভাগ",
    result: "মূল্যায়ন",
    likely_type: "সম্ভাব্য ক্ষেত্র",
    estimated_stage: "সম্ভাব্য ঝুঁকি স্তর",
    suggested_doctors: "কাছাকাছি বিশেষজ্ঞ",
    disclaimer: "এটি একটি AI স্ক্রিনিং মাত্র। অনুগ্রহ করে চিকিৎসকের পরামর্শ নিন।",
    blood_group: "রক্তের গ্রুপ",
    location: "অবস্থান (বিভাগ)",
    search_donors: "ডোনার খুঁজুন",
    become_donor: "ডোনার হোন",
    register_donor: "ডোনার হিসেবে নিবন্ধন",
    donors_found: "ডোনার পাওয়া গেছে",
    ...
    relax_sounds: "প্রশান্তিদায়ক শব্দ",
    rain: "বৃষ্টি",
    forest: "বন",
    ocean: "সমুদ্র",
    stop: "বন্ধ",
    play: "চালান",
    suggestion: "পরামর্শ",
    counseling: "কাউন্সেলিং ও থেরাপি",
    medicine_name: "ওষুধের নাম",
    schedule: "সময়সূচী",
    add_reminder: "রিমাইন্ডার যোগ করুন",
    active_reminders: "চালু রিমাইন্ডার",
    morning: "সকাল",
    noon: "দুপুর",
    night: "রাত",
    remove: "মুছুন",
    notif_msg: "ওষুধ খেয়ে নিন, আপনি দ্রুত সেরে উঠবেন।",
